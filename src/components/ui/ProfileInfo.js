...
const ProfileInfo = ({ uploadData }) => {
        ...
        const fetchProfile = async () => {
            try {
                ...
                if (profileData.success) {
                    ...
                    // Provider info setup
                    const providersResponse = await fetch("http://localhost:3017/api/providers", {
                        method: "GET",
                        credentials: "include",
                    });
    ...
    const handleImageSubmit = async () => {
        ...
        try {
            ...
            if (data.url) {
                ...
                const updateResponse = await fetch("http://localhost:3017/api/users/profile/update-profile", {
                    method: "PUT",
                    headers: {
    ...
    const handleNameChange = async (name) => {
        try {
            ...
            if (name.length > 31) {
                ...
                const providerResponse = await fetch("http://localhost:3017/api/providers/update-provider", {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                    },
                ...
                const userResponse = await fetch("http://localhost:3017/api/users/profile/update-profile", {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                    },
    ...
    const handleBioChange = async (bio) => {
        try {
            ...
            if (bio.length > 206) {
                ...
                const response = await fetch("http://localhost:3017/api/providers/update-provider", {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                    },
    ...
    const handleSaveOthersInfo = async () => {
        try {
            ...
            const additionalInfoResponse = await fetch("http://localhost:3017/api/providers/update-provider", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
