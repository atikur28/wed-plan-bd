...
const ProfileInfo = ({ uploadData }) => {
    ...
    const handleImageSubmit = async () => {
        ...
        try {
            ...
            if (data.url) {
                ...
                const updateResponse = await fetch("http://localhost:3034/api/users/profile/update-profile", {
                    method: "PUT",
                    headers: {
    ...
    const handleBioChange = async (bio) => {
        try {
            ...
            if (bio.length > 206) {
                ...
                const response = await fetch("http://localhost:3034/api/users/profile/update-profile", {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
                    },
    ...
    const handleSaveOthersInfo = async () => {
        try {
            ...
            const additionalInfoResponse = await fetch("http://localhost:3034/api/users/profile/update-profile", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
