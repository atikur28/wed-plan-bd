...
export const sendMail = async ({ email, emailType, userId }) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Click <a href="http://localhost:3000/verifyemail?token=${hashedToken}">here</a> to ${emailType === "VERIFY" ? "verify your email" : "reset your password"} or copy and paste the link below in your browser.
